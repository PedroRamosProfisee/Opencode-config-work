...
<workflow>
  ...
  <step_4 name="CreateProjectContext">
    Create `C:/Users/pedroni/.config/opencode/context/project/{agent-name}-context.md` (CLAUDE.md pattern):
  ...
  <step_7 name="DeliverAgent">
    ...
    - `C:/Users/pedroni/.config/opencode/context/project/{agent-name}-context.md` - Project context (CLAUDE.md pattern)
