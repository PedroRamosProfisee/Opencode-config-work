...
**Core Standards**:
- `C:/Users/pedroni/.config/opencode/context/core/standards/code-quality.md` → Modular, functional code patterns
- `C:/Users/pedroni/.config/opencode/context/core/standards/test-coverage.md` → Testing requirements and TDD
- `C:/Users/pedroni/.config/opencode/context/core/standards/documentation.md` → Documentation standards
- `C:/Users/pedroni/.config/opencode/context/core/standards/security-patterns.md` → Error handling, security patterns

**Core Workflows**:
- `C:/Users/pedroni/.config/opencode/context/core/workflows/task-delegation.md` → Delegation process
- `C:/Users/pedroni/.config/opencode/context/core/workflows/feature-breakdown.md` → Task breakdown methodology
- `C:/Users/pedroni/.config/opencode/context/core/workflows/code-review.md` → Code review guidelines

## Repository-Specific Context (Load These Before Starting)

**Quick Start** (ALWAYS load first):
- `C:/Users/pedroni/.config/opencode/context/openagents-repo/quick-start.md` → Repo orientation and common commands

**Core Concepts** (Load based on task type):
- `C:/Users/pedroni/.config/opencode/context/openagents-repo/core-concepts/agents.md` → How agents work
- `C:/Users/pedroni/.config/opencode/context/openagents-repo/core-concepts/evals.md` → How testing works
- `C:/Users/pedroni/.config/opencode/context/openagents-repo/core-concepts/registry.md` → How registry works
- `C:/Users/pedroni/.config/opencode/context/openagents-repo/core-concepts/categories.md` → How organization works

**Guides** (Load for specific workflows):
- `C:/Users/pedroni/.config/opencode/context/openagents-repo/guides/adding-agent.md` → Step-by-step agent creation
- `C:/Users/pedroni/.config/opencode/context/openagents-repo/guides/testing-agent.md` → Testing workflow
- `C:/Users/pedroni/.config/opencode/context/openagents-repo/guides/updating-registry.md` → Registry workflow
- `C:/Users/pedroni/.config/opencode/context/openagents-repo/guides/debugging.md` → Troubleshooting

**Lookup** (Quick reference):
- `C:/Users/pedroni/.config/opencode/context/openagents-repo/lookup/file-locations.md` → Where everything is
- `C:/Users/pedroni/.config/opencode/context/openagents-repo/lookup/commands.md` → Command reference
...
2. **Copy template**:
   ```bash
   cp C:/Users/pedroni/.config/opencode/context/openagents-repo/templates/context-bundle-template.md \
...
See `C:/Users/pedroni/.config/opencode/context/openagents-repo/examples/context-bundle-example.md` for a complete example.
