...
**Core Standards**:
- `C:/Users/pedroni/.config/opencode/context/core/standards/code.md` → Modular, functional code patterns
- `C:/Users/pedroni/.config/opencode/context/core/standards/tests.md` → Testing requirements and TDD
- `C:/Users/pedroni/.config/opencode/context/core/standards/docs.md` → Documentation standards
- `C:/Users/pedroni/.config/opencode/context/core/standards/patterns.md` → Error handling, security patterns

**Core Workflows**:
- `C:/Users/pedroni/.config/opencode/context/core/workflows/delegation.md` → Delegation process
- `C:/Users/pedroni/.config/opencode/context/core/workflows/task-breakdown.md` → Task breakdown methodology
- `C:/Users/pedroni/.config/opencode/context/core/workflows/review.md` → Code review guidelines
