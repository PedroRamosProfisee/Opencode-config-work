...
### 5. Compress Files
```bash
bash .opencode/skill/context/router.sh compress C:/Users/pedroni/.config/opencode/context/ 100KB
```
Reduces large context files to save space.

### 6. Organize Context
```bash
bash .opencode/skill/context/router.sh organize C:/Users/pedroni/.config/opencode/context/
```
...
### 8. Guided Workflow
```bash
bash .opencode/skill/context/router.sh process "organize authentication context" C:/Users/pedroni/.config/opencode/context/
```
...
./router.sh discover "C:/Users/pedroni/.config/opencode/context/core/"
```
...
./router.sh extract "C:/Users/pedroni/.config/opencode/context/core/" "all standards"
```
...
./router.sh compress "C:/Users/pedroni/.config/opencode/context/" "100 KB"

# Compress all context
./router.sh compress "C:/Users/pedroni/.config/opencode/context/"

# Compress and archive
./router.sh compress "C:/Users/pedroni/.config/opencode/context/development/" "50 KB"
```
...
```bash
# Organize by concern
./router.sh organize "C:/Users/pedroni/.config/opencode/context/"

# Organize specific topic
./router.sh organize "C:/Users/pedroni/.config/opencode/context/development/"
```
...
./router.sh process "organize authentication context" "C:/Users/pedroni/.config/opencode/context/development/"

# Process all development context
./router.sh process "organize all development context" "C:/Users/pedroni/.config/opencode/context/development/"
