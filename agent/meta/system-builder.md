  ...
  <stage id="5" name="OrganizeContext">
    ...
    <routing>
      <route to="ContextOrganizer">
        ...
        <integration>
          Write context files to C:/Users/pedroni/.config/opencode/context/ directory structure
        </integration>
      </route>
    </routing>
  ...
  <stage id="10" name="DeliverSystem">
    ...
    <output_format>
      ...
      **3. Try a Complete Workflow**:
      ...
      - **Context Organization**: `C:/Users/pedroni/.config/opencode/context/navigation.md`
