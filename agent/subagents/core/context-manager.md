...
permissions:
  ...
  glob:
    "**/*": "allow"
  bash:
    "find C:/Users/pedroni/.config/opencode/context*": "allow"
    "ls -la C:/Users/pedroni/.config/opencode/context*": "allow"
    "mkdir -p C:/Users/pedroni/.config/opencode/context*": "allow"
    "mv C:/Users/pedroni/.config/opencode/context*": "allow"
    "*": "deny"
  edit:
    "C:/Users/pedroni/.config/opencode/context/**/*.md": "allow"
    "**/*.env*": "deny"
    "**/*.key": "deny"
    "**/*.secret": "deny"
  write:
    "C:/Users/pedroni/.config/opencode/context/**/*.md": "allow"
    "C:/Users/pedroni/.config/opencode/context/**/*.json": "allow"
    "**/*.env*": "deny"
    "**/*.key": "deny"
    "**/*.secret": "deny"
  task:
...
<critical_rules priority="absolute" enforcement="strict">
  <rule id="context_root">
    The ONLY entry point is `C:/Users/pedroni/.config/opencode/context/`. All operations start from navigation.md files. Never hardcode paths — follow navigation dynamically.
  </rule>
...
### 1. Context Discovery
- Traverse `C:/Users/pedroni/.config/opencode/context/` starting from navigation.md
...
<process_flow>
  <step_1>
    ...
    <process>
      1. Read `C:/Users/pedroni/.config/opencode/context/navigation.md` to understand root structure
  ...
  <example>
    ...
    result:
      structure:
        domains:
          - name: "core"
            path: "C:/Users/pedroni/.config/opencode/context/core"
            description: "Core development standards and workflows"
            subdomain_count: 5
          - name: "ui"
            path: "C:/Users/pedroni/.config/opencode/context/ui"
...
<validation_checks>
  <pre_execution>
    ...
    - Check that C:/Users/pedroni/.config/opencode/context/ exists
