...
- Locate context directories (`C:/Users/pedroni/.config/opencode/context/`, `docs/`, `.context/`, etc.)
...
```
C:/Users/pedroni/.config/opencode/context/
...
```bash
list(path="C:/Users/pedroni/.config/opencode/context")
```
...
list(path="C:/Users/pedroni/.config/opencode/context/{category}")

# Read relevant files
read(filePath="C:/Users/pedroni/.config/opencode/context/{category}/{file}.md")
```
...
**Context Location**: `C:/Users/pedroni/.config/opencode/context/`
**Files Searched**: 12
...
**Primary Location**: `C:/Users/pedroni/.config/opencode/context/`
...
#### ⭐⭐⭐⭐⭐ Code Standards
**Path**: `C:/Users/pedroni/.config/opencode/context/core/standards/code.md`
...
### Files to Load (Priority Order)
1. `C:/Users/pedroni/.config/opencode/context/core/standards/code.md` - CRITICAL for all code implementation
2. `C:/Users/pedroni/.config/opencode/context/core/standards/style-guide.md` - Formatting and style rules
3. `C:/Users/pedroni/.config/opencode/context/development/best-practices.md` - Additional development guidelines
...
### Additional Context Available
If you need more information on:
- **Testing standards** → Check `C:/Users/pedroni/.config/opencode/context/core/standards/tests.md`
- **Design patterns** → Check `C:/Users/pedroni/.config/opencode/context/core/standards/patterns.md`
```
...
**Context Location**: `docs/` and `C:/Users/pedroni/.config/opencode/context/`
**Files Searched**: 8
...
C:/Users/pedroni/.config/opencode/context/core/workflows/
└── review.md ⭐ FOUND
```
...
- Follow code standards in `C:/Users/pedroni/.config/opencode/context/core/standards/code.md`
...
3. `C:/Users/pedroni/.config/opencode/context/core/workflows/review.md` - Code review expectations
...
### Additional Context Available
If you need more information on:
- **Code standards** → Check `C:/Users/pedroni/.config/opencode/context/core/standards/code.md`
- **Testing guidelines** → Check `C:/Users/pedroni/.config/opencode/context/core/standards/tests.md`
```

## Discovery Patterns

### Pattern 1: Well-Organized Context
Repository has clear context structure (`C:/Users/pedroni/.config/opencode/context/` or `docs/`)
...
- `C:/Users/pedroni/.config/opencode/context/` - Not found
- `docs/` - Not found
- `.context/` - Not found
- `context/` - Not found
