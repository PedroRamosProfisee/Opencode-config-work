...
**Replacement**: See `C:/Users/pedroni/.config/opencode/context/project-intelligence/navigation.md` for current project context.

---

## Related Context

- `../openagents-repo/` - Current repository context
