...
C:/Users/pedroni/.config/opencode/context/development/
├── navigation.md
├── clean-code.md
├── react-patterns.md
└── api-design.md
...
mkdir -p C:/Users/pedroni/.config/opencode/context/{category}
...
```bash
cat > C:/Users/pedroni/.config/opencode/context/{category}/navigation.md << 'EOF'
...
```
C:/Users/pedroni/.config/opencode/context/{category}/
...
Loads: `C:/Users/pedroni/.config/opencode/context/development/react-patterns.md`
