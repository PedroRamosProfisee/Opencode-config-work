...
glob(pattern="**/*.md", path="C:/Users/pedroni/.config/opencode/context")

// 2. Use grep to search content
grep(pattern="registry", path="C:/Users/pedroni/.config/opencode/context")

// 3. Read relevant files directly
read(filePath="C:/Users/pedroni/.config/opencode/context/openagents-repo/core-concepts/registry.md")
```
