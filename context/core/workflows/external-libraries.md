...
┌──────────────────────────────────────────────────┐
│ STEP 1: ContextScout                             │
│ → Search internal context (C:/Users/pedroni/.config/opencode/context/)  │
...
- Cache useful docs in `C:/Users/pedroni/.config/opencode/context/development/frameworks/` if frequently used
...
**Rule**: If it's not in `C:/Users/pedroni/.config/opencode/context/`, use ExternalScout.
...
| **Location** | `C:/Users/pedroni/.config/opencode/context/` | Internet (Context7, official docs) |
...
- **Code Standards**: `C:/Users/pedroni/.config/opencode/context/core/standards/code-quality.md`
