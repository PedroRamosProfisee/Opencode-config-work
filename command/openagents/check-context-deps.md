...
<workflow id="analyze_context_dependencies">
  <stage id="1" name="ScanAgents" required="true">
    ...
    **Search patterns**:
    - `C:/Users/pedroni/.config/opencode/context/` (direct path references)
    - `@C:/Users/pedroni/.config/opencode/context/` (@ symbol references)
  ...
  <stage id="3" name="ValidateContextFiles" required="true">
    ...
    **Check existence**:
    ```bash
    test -f C:/Users/pedroni/.config/opencode/context/core/standards/code-quality.md
    ```
  ...
  <stage id="4" name="Report" required="true">
    ...
    **Uses but not declared**:
    - context:core/standards/code (referenced 3 times)
      - Line 64: "Code tasks → C:/Users/pedroni/.config/opencode/context/core/standards/code-quality.md (MANDATORY)"
      - Line 170: "Read C:/Users/pedroni/.config/opencode/context/core/standards/code-quality.md NOW"
...
```bash
grep -rn "\C:/Users/pedroni/.config/opencode/context/" .opencode/agent/ .opencode/command/
```
...
- `C:/Users/pedroni/.config/opencode/context/core/standards/code-quality.md` → `context:core/standards/code`
- `@C:/Users/pedroni/.config/opencode/context/openagents-repo/quick-start.md` → `context:openagents-repo/quick-start`
...
task(
  ...
  prompt=`
    ...
    2. Search for these patterns:
       - "C:/Users/pedroni/.config/opencode/context/core/" (direct paths)
       - "@C:/Users/pedroni/.config/opencode/context/" (@ references)
    ...
    4. For each context file in C:/Users/pedroni/.config/opencode/context/core/:
...
✓ C:/Users/pedroni/.config/opencode/context/core/context-system.md (1 reference)
  - Line 15: "Load: context:core/context-system"
✓ C:/Users/pedroni/.config/opencode/context/core/context-system/standards/mvi.md (2 references)
...
- **Context guide**: `C:/Users/pedroni/.config/opencode/context/openagents-repo/quality/registry-dependencies.md`
