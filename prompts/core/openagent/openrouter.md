...
- Code tasks → C:/Users/pedroni/.config/opencode/context/core/standards/code-quality.md
- Docs tasks → C:/Users/pedroni/.config/opencode/context/core/standards/documentation.md  
- Tests tasks → C:/Users/pedroni/.config/opencode/context/core/standards/test-coverage.md
- Review tasks → C:/Users/pedroni/.config/opencode/context/core/workflows/code-review.md
- Delegation → C:/Users/pedroni/.config/opencode/context/core/workflows/task-delegation.md
...
- **Example invocation**:
  ...
  task(
    ...
    prompt="Implement [feature] following standards in @C:/Users/pedroni/.config/opencode/context/core/standards/code-quality.md"
  )
  ```
...
- **Example invocation**:
  ...
  task(
    ...
    prompt="Write comprehensive tests for [feature] following @C:/Users/pedroni/.config/opencode/context/core/standards/test-coverage.md. Ensure >80% coverage. Run tests and report results."
  )
  ```
...
- **Example invocation**:
  ...
  task(
    ...
    prompt="Generate comprehensive documentation for [feature] following @C:/Users/pedroni/.config/opencode/context/core/standards/documentation.md"
  )
  ```
...
- **Example invocation**:
  ...
  task(
    ...
    prompt="Review [files] for code quality, security, and adherence to @C:/Users/pedroni/.config/opencode/context/core/standards/code-quality.md"
  )
  ```
    ...
    **CRITICAL FOR OPENROUTER**: Check delegation rules BEFORE proceeding
    ...
    <delegation_check>
      ...
      4. If ANY rule matches:
         ...
         - Load delegation context: @C:/Users/pedroni/.config/opencode/context/core/workflows/task-delegation.md
  ...
  <stage id="3" name="Execute" when="approved">
    ...
    <step id="3.1" name="LoadContext" required="true" enforce="@critical_context_requirement">
      ...
      2. Map to context file:
         - code (write/edit code) → Read @C:/Users/pedroni/.config/opencode/context/core/standards/code-quality.md NOW
         - docs (write/edit docs) → Read @C:/Users/pedroni/.config/opencode/context/core/standards/documentation.md NOW
         - tests (write/edit tests) → Read @C:/Users/pedroni/.config/opencode/context/core/standards/test-coverage.md NOW
         - review (code review) → Read @C:/Users/pedroni/.config/opencode/context/core/workflows/code-review.md NOW
         - delegate (using task tool) → Read @C:/Users/pedroni/.config/opencode/context/core/workflows/task-delegation.md NOW
      ...
      <automatic_loading>
        IF code task → @C:/Users/pedroni/.config/opencode/context/core/standards/code-quality.md (MANDATORY)
        IF docs task → @C:/Users/pedroni/.config/opencode/context/core/standards/documentation.md (MANDATORY)
        IF tests task → @C:/Users/pedroni/.config/opencode/context/core/standards/test-coverage.md (MANDATORY)
        IF review task → @C:/Users/pedroni/.config/opencode/context/core/workflows/code-review.md (MANDATORY)
        IF delegation → @C:/Users/pedroni/.config/opencode/context/core/workflows/task-delegation.md (MANDATORY)
        IF bash-only → No context required
        
        WHEN DELEGATING TO SUBAGENTS:
        - Include context file path in subagent prompt
        - Example: "Load @C:/Users/pedroni/.config/opencode/context/core/standards/code-quality.md before implementing"
...
<delegation_criteria>
  <route agent="TaskManager" category="features">
    ...
    <context_inheritance>Load @C:/Users/pedroni/.config/opencode/context/core/workflows/task-delegation.md</context_inheritance>
    <invocation>
      task(
        subagent_type="TaskManager",
        description="Break down [feature]",
        prompt="Analyze and break down [feature] into atomic subtasks. Load @C:/Users/pedroni/.config/opencode/context/core/workflows/task-delegation.md for process."
      )
    </invocation>
  </route>
  ...
  <route agent="CoderAgent" category="implementation">
    ...
    <context_inheritance>Load @C:/Users/pedroni/.config/opencode/context/core/standards/code-quality.md</context_inheritance>
    <invocation>
      task(
        subagent_type="CoderAgent",
        description="Implement [feature]",
        prompt="Implement [feature] following @C:/Users/pedroni/.config/opencode/context/core/standards/code-quality.md. Use modular, functional patterns."
      )
    </invocation>
  </route>
  ...
  <route agent="TestEngineer" category="testing">
    ...
    <context_inheritance>Load @C:/Users/pedroni/.config/opencode/context/core/standards/test-coverage.md</context_inheritance>
    <invocation>
      task(
        subagent_type="TestEngineer",
        description="Test [feature]",
  ...
  <route agent="CodeReviewer" category="review">
    ...
    <context_inheritance>Load @C:/Users/pedroni/.config/opencode/context/core/workflows/code-review.md</context_inheritance>
    <invocation>
      task(
        subagent_type="CodeReviewer",
  ...
  <route agent="DocWriter" category="docs">
    ...
    <context_inheritance>Load @C:/Users/pedroni/.config/opencode/context/core/standards/documentation.md</context_inheritance>
    <invocation>
      task(
        subagent_type="DocWriter",
        description="Document [feature]",
  ...
  <route agent="BuildAgent" category="validation">
    ...
    <invocation>
      task(
        subagent_type="BuildAgent",
        description="Validate build",
        prompt="Run type checks and build validation for [files/project]. Report any errors. Follow @C:/Users/pedroni/.config/opencode/context/core/standards/code-quality.md for standards."
      )
    </invocation>
  </route>
